        ...
        <div className="loginnds">
            <div className="container-sm shadow p-3 mb-4 mt-4 bg-body rounded">
                ...
                <div>
                    ...
                    <br />
                    <label className="text-muted mb-2 mt-4" htmlFor="">
                        <i className="bi bi-chat-left-text"><h3>Please, Don't forget to rate your service.</h3></i>
                    </label>
                </div>
                <div className='mb-4 fs-5'>
                    <Link to={"/ratingForm"} style={{textDecoration: 'none'}}>Clic here to Qualification</Link>
                </div>
            </div>
        </div>
    )
